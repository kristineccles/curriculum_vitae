...
Department of Biology & {\it Website:} \href{https://kristineccles.com}{kristineccles.com}\\
University of Ottawa & {\it GitHub:} \href{https://github.com/kristineccles}{github.com/kristineccles}\\
Gendron Hall, Room 276 & {\it ORCID:} 0000-0002-6629-430X\\
...
36 peer-reviewed publications; 691 citations; h index = 16 and i10 index = 20
\\
...
{\bf  Assistant Professor} \hfill {\bf August 2026 - Present}\\
...
Research Scientist, Health Canada, Ottawa, Canada \hfill {\bf July 2023 - July 2026}\\
Postdoctoral Research Fellow, NIEHS, USA \hfill {\bf Nov 2020 - May 2023}\\
Postdoctoral Fellowship, University of Toronto, Canada \hfill {\bf Aug 2019 - Oct 2020}\\
Research Affiliate, Environment and Climate Change Canada \hfill {\bf Sept 2016 - Aug 2019}\\

%%%%%%% Publications %%%%%%%
\section{\sc Peer-reviewed Publications}
%\begin{etaremune}[start=26]

++Senior Authorship; *Suprevised Trainee or Biologist

Loan, A.*, Nunnikhoven, A., Bradford, L. M., Zhang, G., Meier, M., Aranda-Rodriguez, R., Tayabali, A., Pelletier,
G., \textbf{Eccles, K.M.}++, Prescott, D. (2026). IA human PBMC-based new approach method reveals PFAS-driven T-cell proliferation and immune dysregulation. \textit{Archives of Toxicology}.1-18. \url{https://doi.org/10.1007/s00204-026-04525-6}

Zhang, G., Blais, A., Tayabali, A. F., Pelletier, G., Loan, A.*, Prescott, D., \textbf{Eccles, K.M.}, Aranda-Rodriguez, R. (2026). Enhanced selectivity for PFAS analysis in complex biological matrices by LC–MS/MS: Application to mouse feces and liver.\textit{Journal of Chromatography B}.125264.\url{https://doi.org/10.1016/j.jchromb.2026.125264}

\textbf{Eccles, K.M.}++, Yee, S., Chan, H.M. (2026). Improving Mercury Exposure Estimates: A Meta-analysis of Methylmercury-to-Total Mercury Ratios in Canadian Traditional Foods. \textit{Journal of Exposure Science and Environmental Epidemiology}.1-16. \url{https://doi.org/10.1038/s41370-026-00888-1}

Zhang, G., Wawrzynczak, A., Tseng, G., Blais, A., Nong, A., Tayabali, A.F., Pelletier, G., Loan, A.*, Prescott, P., \textbf{Eccles, K.M.}, Aranda-Rodriguez, R. (2026). A Novel Automated Micro Solid Phase Extraction (µSPE) Method to Quantify 21 Per-and Polyfluoroalkyl Compounds in Biological Samples.17, 100230. \textit{Advances in Sample Preparation}.\url{https://doi.org/10.1016/j.sampre.2026.100230}

\textbf{Eccles, K.M.}, Gaston, K., Green, E.M., Waidyanatha, S., Stuffler, B., Harris, S.F., Rider, C.V., Meadlock Kakaley, E. (2026). Challenging Additivity: Comparing Predicted and Observed AhR Activity of Polycyclic Aromatic Compound (PAC) Mixtures Containing Active and Inactive Constituents. 60, 4, 2976–2987\textit{Environmental Science \& Technology}.\url{https://doi.org/10.1021/acs.est.5c11914}

Blais, A., Loan, A., Cho, E., Woodtke, A., Moteshareie, H., Bradford, L. M., Zhang, G., Pelletier, G., Navarro, M., Meier, J., Nong, A., Aranda-Rodriguez, R., \textbf{Eccles, K.M.}, Prescott, D., Tayabali, A. (2026). PFOS and PFOA Exposure Induces Liver Injury and Sex-Dependent Immune Effects in C57BL/6 Mice. 29.  \textit{iScience}. \url{https://doi.org/10.1016/j.isci.2026.114693}

Heldman, S., \textbf{Eccles, K.M.}, Kassotis, C. (2026). Liquid Crystal Monomers and Their Mixtures Alter Nuclear Receptor Signaling and Promote Adipogenesis In Vitro. \textit{Endocrinology}, 166(11), bqaf143.\url{https://doi.org/10.1210/endocr/bqaf143}
...
Cho, E.*, Baird, S., \textbf{Eccles, K.M.}++ (2025). Smaller Scale, Same Impact: Replicating High-Throughputh Phenotypic Profiling in a Medium- Throughput Lab for Use in Chemical Risk Assessment. 99, 4385–4397. \textit{Archives of Toxicology}, 1-13. \url{https://doi.org/10.1007/s00204-025-04165-2}
...
\section{\sc Peer-reviewed Publications Under Review}
%\begin{etaremune}[start=26]

Loan, A.*, Blais, A., Zhang, G., Aranda-Rodriguez, R., Tayabali, A., \textbf{Eccles, K.M.}++ (submitted). Benchmarking Toxicokinetic Models of PFAS to Predict Human Exposure from Mouse Plasma, Kidney, Liver, and Fecal Data.

%Cho, E.*, Bugiel, S., Bradford, L., Blais, A.*, Prescott, D., Aranda-Rodriguez, R., Tayabali, A., Pelletier, G., Meier, M., Carter, L., \textbf{Eccles, K.M.}++ (submitted). A Translational Toxicology Approach to Quantify the Effect of PFAS Exposure on Gene Expression.\\

%\end{etaremune}

\vspace*{.1in}
\section{\sc Technical Reports}
Health Canada \& Environment and Climate Change Canada. (2025). Strategy to replace, reduce or refine vertebrate animal testing under the Canadian Environmental Protection Act, 1999 (CEPA). \url{https://www.canada.ca/en/environment-climate-change/services/canadian-environmental-protection-act-registry/implementing-modernized-cepa/strategy-replace-reduce-refine-vertebrate-animal-testing.html}

Health Canada. (2025). Combined Exposure to Multiple Chemical (Mixture) Risk Assessment (RA): A Quick Guide for Risk Assessors. Ottawa, Canada. \url{https://www.canada.ca/en/services/health/publications/science-research-data/combined-exposure-multiple-chemicals-risk-assessment-quick-reference-guide.html}
...
\textbf{Eccles K.M.} (2026). Designing Experiments to Reflect Real-World Mixtures: Linking External Dose, Internal  Exposure, and Biological Response. Gordon Research Conference on Environmental Endocrine Disruptors. Newry, Maine, USA.

\textbf{Eccles K.M.} (2026). Translating PFAS Toxicity Across Species: Computational Approaches for Human-Relevant Risk Assessment. Virtual International Union of Toxicology (IUTOX) Seminar Series. Reston, Virgina, USA.
