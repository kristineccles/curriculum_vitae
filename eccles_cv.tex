...
16 journal publications (9 as first author)
\\
172 citations; h index = 7 and i10 index = 6
\\
...
\vspace*{.05in}
\item[] Dissertation title:  Applications of geographic information systems in landscape ecotoxicology
...
\begin{list1}
\item[] M.Sc., Geography
\item[] Thesis title:  Environmental risk mapping for contamination of drinking water wells post-flood in southern Alberta
