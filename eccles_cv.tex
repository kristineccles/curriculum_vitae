...
\\
244 citations; h index = 9 and i10 index = 8
\\
...
\textbf{Eccles K.M.}, Karmaus A.L., Parham, F., Rider, C.V., Kleinstreuer, N.C., Wambaugh, J.F., Messier, K.P. A geospatial modeling approach to quantifying risk of exposure to environmental chemical mixtures via a common molecular target. (In Internal Review)

Cui, Y., \textbf{Eccles K.M.}, Kwok, R.K., Joubert, B., Messier, K.P., Balshaw, D. Integrating Multiscale Geospatial Environmental Data into Large Population Health Studies: Challenges and Opportunities. (In Peer Review)
