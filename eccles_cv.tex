...
27 peer-reviewed publications (11 as first author)
\\
497 citations; h index = 13 and i10 index = 16
\\
...
Parham, F., \textbf{Eccles, K.M.}, Rider, C. V., Sakamuru, S., Xia, M., Huang, R., Tice, R.R., Dinse, G.E., DeVito M.J. (\textit{In Press}) Lessons learned from evaluating defined chemical mixtures in a high throughput estrogen receptor assay system.
...
\textbf{Eccles K.M.}(2025). Bridging Ecosystems and Health: Geospatial Toxicology in the One Health Era. University of Ottawa. Ottawa, Canada.
