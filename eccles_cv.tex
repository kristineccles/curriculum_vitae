...
\\
444 citations; h index = 12 and i10 index = 15
\\
...
Parham, F., \textbf{Eccles, K.M.}, Rider, C. V., Sakamuru, S., Xia, M., Huang, R., Tice, R.R., Dinse, G.E., DeVito M.J. (2024) Lessons learned from evaluating defined chemical mixtures in a high throughput estrogen receptor assay system (\textit{Under Review}).
\pagebreak
